 ...
 *
 * Unlike anthropic-subscription-registry-probe.mjs (which drives the registry APIs
 ...
 *
 * Run with:
 *   node .agents/skills/senpi-qa/scripts/anthropic-subscription-fullstack-probe.mjs --baseline
 *
 * Modes:
...
import {
	...
	seedProbeAgentDir,
	withTimeout,
} from "./lib/anthropic-subscription-fullstack-support.mjs";
...
if (MATRIX) {
	const { runContinuityMatrix } = await import("./lib/anthropic-subscription-matrix.mjs");
