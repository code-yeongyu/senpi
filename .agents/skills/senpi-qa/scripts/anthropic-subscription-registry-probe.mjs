 ...
 *
 * Run with:
 *   node .agents/skills/senpi-qa/scripts/anthropic-subscription-registry-probe.mjs
 *
...
const [{ AnthropicSubscriptionSessionRegistry }, { submitSessionTurn }, sync] = await Promise.all([
