 ...
 *
 * Usage: bun .agents/skills/senpi-qa/scripts/anthropic-subscription-toolless-compact-probe.mjs [--mode toolless|always-tool] [--evidence <dir>]
 */
...
import { seedProbeAgentDir } from "./lib/anthropic-subscription-fullstack-support.mjs";
import { startToollessCompactServer } from "./lib/anthropic-subscription-toolless-compact-server.mjs";
import { applyHermeticEnvironment, assertHermeticEnvironment } from "./lib/anthropic-subscription-hermetic-env.mjs";
