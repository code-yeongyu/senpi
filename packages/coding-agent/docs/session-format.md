...
For TypeScript definitions in your project, inspect `node_modules/@code-yeongyu/senpi/dist/` and `node_modules/@mariozechner/pi-ai/dist/`.
...
### Extended Message Types (from senpi)
