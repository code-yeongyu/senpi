...
function createTreeUI() {
	...
	const ui = {
		...
		// The fork routes both /tree and assistant-message edits through one navigation flow; borrow
		// the real helpers so the fixture exercises the production guard instead of a stub.
		promptBranchSummaryChoice: Reflect.get(InteractiveMode.prototype, "promptBranchSummaryChoice"),
		runTreeNavigation: Reflect.get(InteractiveMode.prototype, "runTreeNavigation"),
	};
