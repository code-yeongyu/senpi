...
|---|-----------|------|---------|---------|
| 1 | `adaptive-threshold/` | `16k-near-threshold.jsonl` | Context near 16k limit plus a 1M model transition that exercises the 384k active ceiling and 288k warmup | 8 |
