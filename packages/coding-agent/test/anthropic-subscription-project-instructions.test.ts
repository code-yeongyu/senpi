...
import {
	type AnthropicSubscriptionQueryOptionsInput,
...
function optionsFor(
	...
	providerSettings: AnthropicSubscriptionQueryOptionsInput["providerSettings"] = { systemPromptMode: "preset-append" },
) {
...
function appendOf(queryOptions: ReturnType<typeof buildAnthropicSubscriptionQueryOptions>): string {
