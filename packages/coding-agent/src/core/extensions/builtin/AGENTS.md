...
| 7 | `prompt-preset` | `prompt-preset/` | Per-model system prompts (gpt-5.x, gpt-6-astra, claude-fable-5, claude-fable-5-1, claude-opus-5, claude-opus-4-{5,6,7,8}, glm-5.2, glm-5.3, deepseek-v4-{flash,flash-0731,pro}, deepseek-v4-1-flash, grok-4.{5,6}, kimi-k2-{6,7,8}, kimi-k3) |
...
| 35 | `claude-sdk-oauth` | `anthropic-subscription/` | Claude SDK OAuth provider: multi-account OAuth, resume-first session continuity, stream-safe failover — see `anthropic-subscription/AGENTS.md` + `changes.md` |
