...
} from "./extensions/builtin/index.js";
...
const GENERATED_GLOBAL_EXTENSION_BANNER =
	"// Generated by senpi. Delete this file to stop loading the default global extension.\n";
const LEGACY_GENERATED_GLOBAL_EXTENSION_BANNERS = [
	GENERATED_GLOBAL_EXTENSION_BANNER,
...
export class DefaultResourceLoader implements ResourceLoader {
	...
	private ensureGlobalDefaultExtensions(): void {
		...
		for (const extensionId of globalDefaultExtensionIds) {
			...
			const targetPath = join(extensionsDir, `${extensionId}.js`);
