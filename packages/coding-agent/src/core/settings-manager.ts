...
export interface CompactionSettings {
	...
	keepRecentTokens?: number; // default: model-specific (35000 for large-context models, otherwise 20000)
	maxContextTokens?: number; // default: 384000 for large-context models, otherwise contextWindow - reserveTokens
...
export class SettingsManager {
	...
	getCompactionSettings(): {
		...
		return {
			...
			keepRecentTokensConfigured: this.settings.compaction?.keepRecentTokens !== undefined,
