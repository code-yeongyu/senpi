...
async function generateModels() {
	...
	// Command Code Provider API (https://api.commandcode.ai/provider/v1) serves
	// Anthropic models over the Anthropic Messages route and every other model
	// over the OpenAI Chat Completions route; the API rejects a model sent to the
	// wrong endpoint. Model ids and context windows mirror the live catalog at
	// /provider/v1/models.
	const commandcodeOpenAICompat: OpenAICompletionsCompat = {
		supportsStore: false,
		supportsDeveloperRole: false,
		supportsStrictMode: false,
		supportsLongCacheRetention: false,
	...
	const commandcodeModels: Model<"openai-completions" | "anthropic-messages">[] = [
		{
			id: "claude-fable-5",
			name: "Claude Fable 5",
			api: "anthropic-messages",
			...
			contextWindow: 1000000,
			maxTokens: 128000,
			compat: { supportsDisabledThinking: false, forceAdaptiveThinking: true, supportsStrictTools: true },
		...
		},
		{
			...
			contextWindow: 1000000,
			maxTokens: 384000,
			compat: commandcodeOpenAICompat,
		},
		{
