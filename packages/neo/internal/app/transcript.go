...
var transcriptIgnoredEvents = map[string]string{
	...
	"summarization_retry_scheduled":     "summarization retry status rendering is not part of Neo's transcript projection",
	"summarization_retry_attempt_start": "summarization retry status rendering is not part of Neo's transcript projection",
	"summarization_retry_finished":      "summarization retry status rendering is not part of Neo's transcript projection",
