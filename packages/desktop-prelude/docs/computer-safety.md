...
- A `Suspended` or `StopPathUnavailable` error means the user stopped or cannot stop you: halt computer input and report; NEVER retry around it or try to resume it yourself.
</critical>
