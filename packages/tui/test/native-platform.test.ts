...
test("writes Windows clipboard text through the native helper without command fallbacks", {
...
test("uses the native platform helper directly as the clipboard API", {
